...
String copyright = String.format("&copy; %s 命叔炸鸡连锁店。保留所有权利。", year);
...
<html>
  ...
  <body style="background-image: url('img/login-bg2.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
    ...
    <div class="container-fluid">
      <div class="panel login-panel">
        <div class="panel-header panel-default">
          <img src="img/banner_small.png" width="192px">
        </div>
